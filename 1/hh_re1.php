    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php foreach($work_experience as $key => $work_experience): ?>
          <div class="w3-container">
            <?php if ($key==''): ?> 
              <h5 class="w3-opacity"><b><?=$work_experience['name']?></b></h5> 
            <?php else: ?>
              <h5 class="w3-opacity"><b><?=$work_experience['name']?>/<?=$work_experience['site']?></b></h5> 
              <?php endif;?>
            <?php if ($key==''): ?> 
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$work_experience['date_start']?> - <span class=
                "w3-tag w3-teal w3-round">Current</span></h6>
            <?php else: ?>
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$work_experience['date_start']?> - <i class=
                "margin-right"></i><?=$work_experience['date_finish']?></h6> 
            <?php endif;?>
